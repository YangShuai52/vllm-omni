...
if HAS_TRITON:
    ...
    _indexed_scale_shift_kernel = None
    _indexed_gate_kernel = None
    _rms_norm_indexed_scale_shift_kernel = None
    _indexed_gate_rms_norm_scale_shift_kernel = None
...
def indexed_gate_rms_norm_scale_shift(
    ...
    if residual.is_cpu or not HAS_TRITON:
